...
fn test_split_by_chars() {
    ...
    assert_eq!(
        "This is a test string for split_by_chars.".split_by_chars(10),
        vec![
            S("This is a"),
            S("test"),
            S("string for"),
    ...
    assert_eq!(
        "This is a line\n\nthis is also a line.".split_by_chars(79),
        vec![S("This is a line"), S("."), S("this is also a line."),]
    );
    ...
    assert_eq!(
        "    This  is an 4-indented line\n".split_by_chars(79),
        vec![S("    This  is an 4-indented line"),]
    );

    assert_eq!(
        "    This  is an 4-indented line\n".split_by_chars(3),
        vec![S("    This"), S(" is"), S("an"), S("4-indented"), S("line"),]
    );

    assert_eq!(
        "    indent,    then space".split_by_chars(4),
        vec![S("    indent,"), S("   then"), S("space"),]
    );

    assert_eq!(
        "  trailing space    ".split_by_chars(12),
        vec![S("  trailing"), S("space    "),]
    );

    assert_eq!(
        "  trailing space    ".split_by_chars(16),
        vec![S("  trailing space"), S("."),]
    );
    ...
    assert_eq!(
        "\t\ttabs are\treplaced with spaces\t".split_by_chars(10),
        vec![
            S("    tabs"),
            S("are "),
            S("replaced"),
